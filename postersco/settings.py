"""
Django settings for postersco project.
...
SECRET_KEY = 'django-insecure-bzx99dc#h-el(ac3#cfz6yany=mv^+48yn5q$zsj#i7-835h=9'
...
WSGI_APPLICATION = 'postersco.wsgi.application'
